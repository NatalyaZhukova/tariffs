...
public class SearchTariffs {
	...
	public TariffList searchByInnerCallPrice(TariffList list, int minPrice, int maxPrice) {
	...
	public TariffList searchByOuterCallPrice(TariffList list, int minPrice, int maxPrice) {
	...
	public TariffList searchBySMSPrice(TariffList list, int minPrice, int maxPrice) {
	...
	public TariffList searchByBasicInternetPrice(TariffList list, int minPrice, int maxPrice) {
		
		TariffList searchResults = new TariffList();
		
		for (int i=0; i<list.getListSize(); i++) {
			int basicInternetPrice = list.getTariffByIndex(i).getBasicInternetPrice();
			
			if ((basicInternetPrice>=minPrice) && (basicInternetPrice<=maxPrice)) {
				searchResults.addNewTariff(list.getTariffByIndex(i));
			}
		}
		return searchResults;	
	...
	public TariffList searchBySubscriptionFee(TariffList list, int minFee, int maxFee) {
	...
	public TariffList searchByInternationalCallPrice(TariffList list, int minPrice, int maxPrice) {
		
		TariffList searchResults = new TariffList();
		
		for (int i=0; i<list.getListSize(); i++) {
			int internationalCallPrice = list.getTariffByIndex(i).getInternationalCallPrice();
			
			if ((internationalCallPrice>=minPrice) && (internationalCallPrice<=maxPrice)) {
				searchResults.addNewTariff(list.getTariffByIndex(i));
			}
		}
		return searchResults;	
	...
	public TariffList searchByIncludedInnerCalls(TariffList list, int minCalls, int maxCalls) {
	...
	public TariffList searchByIncludedOuterCalls(TariffList list, int minCalls, int maxCalls) {
	...
	public TariffList searchByIncludedSMS(TariffList list, int minSMS, int maxSMS) {
	...
	public TariffList searchByIncludedInternetTraffic(TariffList list, int minTraffic, int maxTraffic) {
